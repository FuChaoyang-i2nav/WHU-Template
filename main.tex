...
\subsection{插入图片}
WHU校徽如\autoref{whu-logo}所示，注意这里使用了\verb|~\autoref{}|命令，也就是会自动生成“图”“式”等前缀，无需手动输入。


\begin{figure}[!htbp]
    \centering
    \includegraphics[width =.4\textwidth]{figures/whu_logo.png}
    \caption{武汉大学-logo}
    \label{whu-logo}
\end{figure}
...
\subsection{发布地址}
\begin{itemize}
    \item Github: \url{https://github.com/FuChaoyang-i2nav/WHU-Template}
\end{itemize}
